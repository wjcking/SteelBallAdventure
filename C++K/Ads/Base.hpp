#ifndef __base_HELPER_H__
#define __base_HELPER_H__
#if (CC_TARGET_PLATFORM == CC_PLATFORM_ANDROID)
#include "google_play_services/availability.h"
#endif
#include "base/admob/types.h"
...
#include "base/admob/interstitial_ad.h"
#include "base/admob/banner_view.h"
...
{
private:
	static base::admob::AdRequest my_ad_request;
	static base::admob::InterstitialAd* interstitial_ad;
	static base::admob::BannerView* banner_view;
    static bool  isInterstitialReady;
	static bool  isBannerReady;
	static void OnCompletionCallback(const base::Future<void>& future, void* user_data);
